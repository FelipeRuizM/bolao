const en = {
  ...
  points: {
    ...
    brazilDesc: 'Group-stage Brazil games keep the 3× bonus. From the knockouts on, a Brazil match instead adds +1 to that round’s multiplier — e.g. the 6× final becomes 7×.',
    ...
    exampleStep3: 'Brazil in the knockout: +1 → {n}',
