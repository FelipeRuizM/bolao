const en = {
  ...
  admin: {
    ...
    bigGameHeading: 'Big game',
    bigGameDesc:
      'Pick one match where points are multiplied. The multiplier stacks on top of the stage and Brazil rules.',
    bigGameMultiplierLabel: 'Multiplier',
    bigGameStackingHint: 'Stacks: stage × Brazil × {n}× big game.',
    bigGameSave: 'Set big game',
    bigGameSaved: 'Big game set. Leaderboard recomputed.',
    bigGameCleared: 'Big game cleared. Leaderboard recomputed.',
    bigGameClear: 'Clear',
