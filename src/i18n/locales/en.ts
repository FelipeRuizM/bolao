const en = {
  ...
  matches: {
    ...
    noOpen: 'No matches open for picks right now. Try "Locked" or "Previous".',
    noLocked: 'No upcoming matches beyond the pick window.',
  ...
  quickPick: {
    ...
    allPicked: "You're all caught up — every open match has your pick. 🎉",
    filterToPick: 'To Pick',
    filterAll: 'All',
    saving: 'Saving…',
    saved: 'Saved',
    error: 'Not saved',
  ...
  matchDetail: {
    ...
    whoPickedCount: '{n} of {total}',
    whoPickedHint: 'Picks stay hidden until the match starts — you can only see who has locked one in.',
    picked: 'Picked',
    notPickedYet: 'not yet',
    bigGameBannerTitle: 'Big game',
    bigGameBannerDesc: 'Points on this match get a +1 bonus to the multiplier, on top of the stage and Brazil rules.',
  },
  tier: {
    exact: 'Exact',
  ...
  points: {
    ...
    brazilGroupRow: 'Brazil in the group stage',
    brazilKnockoutRow: 'Brazil in a knockout match',
    brazilDesc: 'Group-stage Brazil games keep the 3× bonus. From the knockouts on, a Brazil match instead adds +2 to that round’s multiplier — e.g. the 6× final becomes 8×.',
    ...
    exampleStep3: 'Brazil in the knockout: +{b} → {n}',
  ...
  me: {
    ...
    summaryVsAvg: 'vs avg',
    streakDescription: 'consecutive scoring picks',
    accuracyDescription: 'finished picks that scored',
    vsAvgAbove: '+{n} above pool avg',
    vsAvgBelow: '{n} below pool avg',
    vsAvgEven: 'at pool avg',
  ...
  admin: {
    ...
    pointValuesDesc:
      'Base points per tier (highest matching tier wins). Stage multipliers and the Brazil rule are applied on top — see the Points page for the current values.',
    ...
    playersDesc:
      'The group box controls which leaderboard a player appears on (blank = main). Hide players who gave up — they vanish from the leaderboard but still count toward the prize pool.',
    playersLoading: 'Loading players…',
    playersEmpty: 'No players yet.',
    groupLabel: 'Group',
    hidePlayer: 'Hide',
    showPlayer: 'Show',
    playerHiddenBadge: 'Hidden',
    editPick: 'Edit',
    editPickSave: 'Save pick',
    editPickCancel: 'Cancel',
    editPickHome: 'Home score',
    editPickAway: 'Away score',
    prizeHeading: 'Pool prize',
    prizeDesc:
      'Total pot = player count × amount per player (admins excluded). Shown above the leaderboard. Currency: BRL.',
    prizePerUserLabel: 'Amount per player',
    prizePreview: '{amount} per player',
    prizeSave: 'Save prize',
    prizeSaved: 'Saved {amount} per player.',
    bigGameHeading: 'Big games',
    bigGameDesc:
      'Flag matches that get a +1 bonus to their multiplier, on top of the stage and Brazil rules.',
    bigGameStackingHint: 'Adds +1 to this match’s multiplier.',
    bigGameSave: 'Add big game',
    bigGameSaved: 'Big game added. Leaderboard recomputed.',
    bigGameCleared: 'Big game removed. Leaderboard recomputed.',
    bigGameClear: 'Clear',
    bigGameCurrent: '+1 multiplier',
  },
  profile: {
    title: 'Profile',
    back: '← Back to leaderboard',
