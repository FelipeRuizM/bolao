const en = {
  ...
  matchDetail: {
    ...
    bigGameBannerDesc: 'Points on this match are multiplied by {n}×, stacked on top of the stage and Brazil rules.',
  },
  tier: {
    exact: 'Exact',
  ...
  admin: {
    ...
    playersDesc:
      'The group box controls which leaderboard a player appears on (blank = main).',
    ...
    bigGameDesc:
      'Pick matches where points are multiplied. Each multiplier stacks on top of the stage and Brazil rules.',
    bigGameMultiplierLabel: 'Multiplier',
    bigGameStackingHint: 'Stacks: stage × Brazil × {n}× big game.',
