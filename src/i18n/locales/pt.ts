...
const pt: typeof en = {
  ...
  matches: {
    ...
    filterOpen: 'Abertos',
    filterFuture: 'Futuros',
    filterPrevious: 'Anteriores',
    noOpen: 'Nenhum jogo aberto para palpite agora. Tente "Futuros" ou "Anteriores".',
  ...
  matchDetail: {
    ...
    predictionsNotOpenHeading: 'Os palpites abrem em breve',
  ...
  admin: {
    ...
    prizePreview: '{amount} por pagante',
