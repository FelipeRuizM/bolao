...
const pt: typeof en = {
  ...
  admin: {
    ...
    bigGameHeading: 'Jogão',
    bigGameDesc:
      'Escolha um jogo onde os pontos são multiplicados. O multiplicador empilha em cima da fase e da regra do Brasil.',
    bigGameMultiplierLabel: 'Multiplicador',
    bigGameStackingHint: 'Empilha: fase × Brasil × {n}× do jogão.',
    bigGameSave: 'Definir jogão',
    bigGameSaved: 'Jogão definido. Ranking recalculado.',
