...
const pt: typeof en = {
  ...
  points: {
    ...
    brazilDesc: 'Jogos do Brasil na fase de grupos mantêm o bônus de 3×. A partir do mata-mata, um jogo do Brasil passa a somar +1 ao multiplicador da fase — ex.: a final de 6× vira 7×.',
    ...
    exampleStep3: 'Brasil no mata-mata: +1 → {n}',
