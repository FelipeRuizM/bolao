...
const pt: typeof en = {
  ...
  matchDetail: {
    ...
    predictionsOpenAt: 'Os palpites abrem {when} (uma semana antes do início).',
    ...
    bigGameBannerDesc: 'Os pontos deste jogo são multiplicados por {n}×, empilhando em cima da fase e da regra do Brasil.',
  },
  tier: {
    exact: 'Cravou',
  ...
  points: {
    ...
    exampleStep3: 'Regra do Brasil: {n}',
  ...
  admin: {
    ...
    pointValuesDesc:
      'Pontos base por categoria (a maior que se aplicar vence). Os multiplicadores de fase e a regra do Brasil (3×) são aplicados em cima — veja a página de Pontos para os valores atuais.',
    ...
    playersDesc:
      'A caixa de grupo controla em qual ranking o jogador aparece (vazio = main).',
    ...
    bigGameDesc:
      'Escolha jogos onde os pontos são multiplicados. Cada multiplicador empilha em cima da fase e da regra do Brasil.',
    bigGameMultiplierLabel: 'Multiplicador',
    bigGameStackingHint: 'Empilha: fase × Brasil × {n}× do jogão.',
    ...
    bigGameCurrent: 'Multiplicador {n}×',
  },
  profile: {
    title: 'Perfil',
    back: '← Voltar ao ranking',
